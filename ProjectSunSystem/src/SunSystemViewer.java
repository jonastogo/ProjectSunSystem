...
public class SunSystemViewer extends Application {
	...
	private static final double	Venus_RADIUS		= 40;
	...
	private static final double	um_Venus_RADIUSa	= 600;
	private static final double	um_Venus_RADIUSb	= 429;
	...
	private static final double	Moonstep		= 0.3219748405113880;
	...
	public void start(Stage stage) {
		...
		KeyFrame moveEarth = new KeyFrame(Duration.seconds(.0200), new EventHandler<ActionEvent>() {
			public void handle(ActionEvent event) {
				...
				Venus.x = (int) ((um_Venus_RADIUSa+sun_RADIUS) * Math.sin(Venusangle)) + sun.x;
				Venus.z = (int) ((um_Venus_RADIUSb+sun_RADIUS) * Math.cos(Venusangle)) + sun.z;
